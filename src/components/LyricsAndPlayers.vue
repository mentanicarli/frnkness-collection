<template>
  ...
  <div id="fullscreen-player" class="fullscreen-player">
    ...
    <div class="fs-header-buttons">
      <button id="fs-lyrics-toggle" @click="toggleFsLyrics" class="fs-header-btn" aria-label="Текст песни">
    ...
    <div style="width: 100%; padding: 0 clamp(12px, 3vw, 48px);">
      <div class="py-3 flex items-center justify-between w-full" style="gap: clamp(8px, 1.5vw, 16px);">
        ...
        <div class="flex items-center flex-shrink-0" style="gap: clamp(6px, 1.2vw, 12px);">
          ...
          <button id="play-pause-btn" @click="togglePlay" class="play-btn w-10 h-10 rounded-full bg-white text-black flex items-center justify-center relative" aria-label="Воспроизвести">
...
const prevTrack = () => legacyBridge.prevTrack()
const togglePlay = () => legacyBridge.togglePlay()
const nextTrack = () => legacyBridge.nextTrack()
